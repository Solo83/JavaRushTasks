...
public class Task0825 {
    public static int A = 5; //Статики - это наши чиновники, т.е. видят только себя и обращаются только друг к другу.
    public static int B = 2;

    public int C = A * B; //Нестатики - это простые граждане, которые обращаются друг к другу, но и обивают пороги чиновников.
