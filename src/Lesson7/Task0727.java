...
public class Task0727 {
    public static void main(String[] args) throws IOException {
        ...
        ArrayList<String> resultStrings1 = new ArrayList<String>();

        for (int i = 0; i < strings.size(); i++) {

            if (strings.get(i).length() %2 == 0)      {resultStrings1.add(strings.get(i)+ " " +strings.get(i));}
            else if (strings.get(i).length() %2 != 0) {resultStrings1.add(strings.get(i)+ " " +strings.get(i)+ " " +strings.get(i));}
            else {resultStrings1.add(strings.get(i));}
        }

        for (int i = 0; i < resultStrings1.size(); i++) {
            System.out.println(resultStrings1.get(i));
        }
    }
}
